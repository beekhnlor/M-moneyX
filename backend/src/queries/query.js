const register =`INSERT INTO tb_users (user_name,phone_number,password,created_At,updated_At) VALUE (?,?,?,?,?)`;

const CheckUser = `SELECT phone_number FROM tb_users WHERE  phone_number = ?`

const login = `SELECT id,user_name,phone_number,role,password FROM tb_users WHERE phone_number = ?`
